...
class QuestionaireDData(models.Model):
	...
	question_20 = models.CharField(max_length=400,verbose_name="question 20", choices=question_C, default=1)#choice= question_C
...
class QuestionaireStakeHolders(models.Model):
	...
	question_26 = models.CharField(max_length=400,verbose_name="question 26", choices=question_C, default=1) #choices=question_C,
